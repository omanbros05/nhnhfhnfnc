        ...
        private void frmCompanyDangerChemicalsProduce_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (CompanyDangerChemicalsProduce != null)
                {
                    ...
                    if (CompanyDangerChemicalsProduce.Company.IsCity == 0)
                    {
                        this.radioButton2.Checked = true;
                    }
                    try
                    {
                        CompanyArea area = (CompanyArea)InvokeUtil.SystemService.EntityInit(new CompanyArea { ID = CompanyDangerChemicalsProduce.Company.CompanyAreaID });
