...
{
    public class PostgreSqlQueryFactory : NBearLite.SqlQueryFactory
    {
        ...
        protected override void PrepareCommand(DbCommand cmd)
        {
            ...
            if (pos > 0)
            {
                ...
                string newSql = cmd.CommandText.Substring(0, pos) + string.Format("cast(cast({0} as decimal) as real)", columnName);
