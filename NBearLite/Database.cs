...
namespace NBearLite
{
    ...
    public sealed class Database : ILogable
    {
            ...
            int batchSize, DbTransaction tran)
        {
            ...
            if (typeof(NBearLite.DbProviders.SqlServer.SqlDbProvider).IsAssignableFrom(dbProvider.GetType()))
            {
        ...
        /// <summary>
        /// Build Update Entity SQL.
        /// </summary>
        /// <param name="table"></param>
        /// <returns></returns>
        //public int Update(object entity, string tableName,params string[] fieldNames)
        //{
        ...
        {
            DbType dbType = DataUtils.GetDbType(value);
        ...
        /// <param name="name"><para>The name of the parameter.</para></param>
        /// <param name="value"><para>The value of the parameter.</para></param>      
        public void AddInParameter(DbCommand command, string name, Guid value)
        {   
            AddParameter(command, name, DbType.String, ParameterDirection.Input, String.Empty, DataRowVersion.Default, value.ToString());
        }
        ...
        /// <param name="name"><para>The name of the parameter.</para></param>
        /// <param name="value"><para>The value of the parameter.</para></param>      
        public void AddInParameter(DbCommand command, string name, int value)
        {
            AddParameter(command, name, DbType.Int32, ParameterDirection.Input, String.Empty, DataRowVersion.Default, value);
        }
