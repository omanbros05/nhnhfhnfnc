...
namespace NBearLite
{
    public abstract class ColumnFormatter
    {
        ...
        public static string Func(string funcName, string columnName)
        {
        ...
        public static string CountBig(string columnName)
        {
            return CountBig(columnName, false);
        }

        public static string CountBig(string columnName, bool isDistinct)
        {
            Check.Require(!string.IsNullOrEmpty(columnName), "columnName could not be null or empty!");
        ...
        public static string DateAdd(string columnName, DatePartType partType, int offset)
        {
            Check.Require(!string.IsNullOrEmpty(columnName), "columnName could not be null or empty!");

            StringBuilder sb = new StringBuilder("DATEADD(");
            sb.Append(partType.ToString());
            sb.Append(',');
            sb.Append(offset);
            sb.Append(',');
        ...
        public static string ToNumber(string columnName)
        {
            ...
            return "cast(cast(" + columnName + " as money) as float)";
        }
    }
}
