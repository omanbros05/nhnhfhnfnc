...
namespace SOA.ORM
{
	...
	/// 实体类
	/// </summary>
	[Table("SaveEvidenceProceAudit", true)]
	public partial class SaveEvidenceProceAudit : BaseEntity<SaveEvidenceProceAudit>
	{
		private int _ID ;
		/// <summary>
		/// 编号 [ID]
		...
		/// 构造函数
		/// </summary>
		internal SaveEvidenceProceAudit(int id)
		{
			ID = id;
			Init();
		}
		...
		{
			SelectSqlSection section = DB.Select(DataBases.SaveEvidenceProceAudit).Where(DataBases.SaveEvidenceProceAudit.ID == ID);
			Init(section,DataBases.SaveEvidenceProceAudit);
		}
		...
		{
			SelectSqlSection section = DB.Select(DataBases.SaveEvidenceProceAudit,DataBases.SaveEvidenceProceAudit.ID.Count()).Where(DataBases.SaveEvidenceProceAudit.ID == ID);
			Update(section,DataBases.SaveEvidenceProceAudit);
		}
		...
		{
			DeleteSqlSection section = DB.Delete(DataBases.SaveEvidenceProceAudit).Where(DataBases.SaveEvidenceProceAudit.ID == ID);
			Remove(section,DataBases.SaveEvidenceProceAudit);
		}
	}
}
