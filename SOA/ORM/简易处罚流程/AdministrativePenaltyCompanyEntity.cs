...
namespace SOA.ORM
{
    ...
    /// 行政处罚决定书
    /// </summary>
    [Table("AdministrativePenaltyCompany", true)]
    public partial class AdministrativePenaltyCompany : BaseEntity<AdministrativePenaltyCompany>
    {
        private int _ID;
        /// <summary>
        /// 自动编号 [ID]
        ...
        /// 默认构造函数
        /// </summary>
        public AdministrativePenaltyCompany()
        { }
        ...
        /// 构造函数
        /// </summary>
        internal AdministrativePenaltyCompany(int id)
        {
            ID = id;
            Init();
        }
        ...
        {
            SelectSqlSection section = DB.Select(DataBases.AdministrativePenaltyCompany).Where(DataBases.AdministrativePenaltyCompany.ID == ID);
            Init(section, DataBases.AdministrativePenaltyCompany);
        }
        ...
        {
            SelectSqlSection section = DB.Select(DataBases.AdministrativePenaltyCompany, DataBases.AdministrativePenaltyCompany.ID.Count()).Where(DataBases.AdministrativePenaltyCompany.ID == ID);
            Update(section, DataBases.AdministrativePenaltyCompany);
        }
        ...
        {
            DeleteSqlSection section = DB.Delete(DataBases.AdministrativePenaltyCompany).Where(DataBases.AdministrativePenaltyCompany.ID == ID);
            Remove(section, DataBases.AdministrativePenaltyCompany);
        }
    }
}
