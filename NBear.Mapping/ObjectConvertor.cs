...
namespace NBear.Mapping
{
    public static class ObjectConvertor
    {
        ...
        {
            ObjectMapper objectMapper = ConfigurationManager.GetObjectMapper(inputType, outputType, viewName);
        ...
        /// <returns></returns>
        public static OutputType[] ToArray<InputType, OutputType>(object inputList)
            where InputType : class
            where OutputType : class
        {
            return ToArray<InputType, OutputType>(inputList, string.Empty);
        }
        ...
        /// <param name="inputList">The input list.(IEnumerable or DataTable or DataReader)</param>
        /// <returns></returns>
        public static List<OutputType> ToList<InputType, OutputType>(object inputList)
            where InputType : class
            where OutputType : class
        {
        ...
        /// <returns></returns>
        public static OutputType[] ToArray<InputType, OutputType, InitType>(object inputList)
            where InputType : class
            where OutputType : class
            where InitType : class
        {
            return ToArray<InputType, OutputType, InitType>(inputList, string.Empty);
        }
        ...
        /// <param name="inputObject">The input object.(IEnumerable or DataTable or DataReader)</param>
        /// <returns></returns>
        public static List<OutputType> ToList<InputType, OutputType, InitType>(object inputList)
            where InputType : class
            where OutputType : class
            where InitType : class
        {
        ...
        /// <param name="viewName">Name of the view.</param>
        /// <returns></returns>
        public static OutputType[] ToArray<InputType, OutputType>(object inputList, string viewName)
            where InputType : class
            where OutputType : class
        {
            return ToArray<InputType, OutputType, OutputType>(inputList, viewName);
        }
        ...
        /// <param name="viewName">Name of the view.</param>
        /// <returns></returns>
        public static List<OutputType> ToList<InputType, OutputType>(object inputList, string viewName)
            where InputType : class
            where OutputType : class
        {
        ...
        /// <param name="viewName">Name of the view.</param>
        /// <returns></returns>
        public static OutputType[] ToArray<InputType, OutputType, InitType>(object inputList, string viewName)
            where InputType : class
            where OutputType : class
            where InitType : class
        {
            return ToArray<OutputType>(inputList, typeof(InputType), typeof(InitType), viewName);
        }
        ...
        /// <param name="viewName">Name of the view.</param>
        /// <returns></returns>
        public static List<OutputType> ToList<InputType, OutputType, InitType>(object inputList, string viewName)
            where InputType : class
            where OutputType : class
            where InitType : class
        {
        ...
        /// <param name="viewName">Name of the view.</param>
        /// <returns></returns>
        public static OutputType[] ToArray<OutputType>(object inputList, Type inputType, Type initType, string viewName)
            where OutputType : class
        {
             return ToList<OutputType>(inputList, inputType, initType, viewName).ToArray();
        }
        /// <summary>
        /// 	convert to list
        /// </summary>
        ...
        /// <param name="viewName">Name of the view.</param>
        /// <returns></returns>
        public static List<OutputType> ToList<OutputType>(object inputList, Type inputType, Type initType, string viewName)
            where OutputType : class
        {
        ...
        /// <param name="outputType">Type of the output.</param>
        /// <returns></returns>
        public static object[] ToArray(object inputList, Type inputType, Type outputType)
        {
            return ToArray(inputList, inputType, outputType, string.Empty);
        }
        /// <summary>
        /// 	ToArray
        /// </summary>
        ...
        /// <param name="viewName">Name of the view.</param>
        /// <returns></returns>
        public static object[] ToArray(object inputList, Type inputType, Type outputType, string viewName)
        {
            return ToArray(inputList, inputType, outputType, viewName);
        }
        /// <summary>
        /// 	ToArray
        /// </summary>
        ...
        /// <param name="viewName">Name of the view.</param>
        /// <returns></returns>
        public static object[] ToArray(object inputList, Type inputType, Type outputType, Type initType, string viewName)
        {
