...
namespace System
{
    ...
    public sealed class ReflectionUtils
    {
        ...
        public static object GetFieldValue(object instance, string fieldName)
        {
            ...
            System.Reflection.PropertyInfo pi = ReflectionUtils.DeepGetProperty(instance.GetType(), fieldName);
            if (pi != null)
            {
                return pi.GetValue(instance, null);
            }

            System.Reflection.FieldInfo fi = ReflectionUtils.DeepGetField(instance.GetType(), fieldName, true, false, false);
            if (fi != null)
            {
        ...
        /// <param name="mi"></param>
        /// <returns></returns>
        public static object GetFieldValue(object instance, System.Reflection.MemberInfo mi)
        {
            Check.Require(instance, "instance");
            Check.Require(mi, "mi");

            if (mi is System.Reflection.PropertyInfo)
                return ((System.Reflection.PropertyInfo)mi).GetValue(instance, null);

            if (mi is System.Reflection.FieldInfo)
                return ((System.Reflection.FieldInfo)mi).GetValue(instance);
        ...
        /// <param name="mi"></param>
        /// <param name="fieldValue"></param>
        public static void SetFieldValue(object instance, System.Reflection.MemberInfo mi, object fieldValue)
        {
            Check.Require(instance, "instance");
            Check.Require(mi, "mi");

            if (mi is System.Reflection.PropertyInfo)
                ((System.Reflection.PropertyInfo)mi).SetValue(instance, fieldValue, null);

            if (mi is System.Reflection.FieldInfo)
                ((System.Reflection.FieldInfo)mi).SetValue(instance, fieldValue);
        }
    }
}
